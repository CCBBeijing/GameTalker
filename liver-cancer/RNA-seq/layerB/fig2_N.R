...
result1_N = qsODE_all(dat, 1, c(2,4,5,8), Time = TT2,LOP_order = 3,maxit = 1000000)#
result2_N = qsODE_all(dat, 2, c(1,5), Time = TT2,LOP_order = 3)#
result3_N = qsODE_all(dat, 3, c(1,5), Time = TT2,LOP_order = 3)
result4_N = qsODE_all(dat, 4, c(1,5), Time = TT2,LOP_order = 3)
result5_N = qsODE_all(dat, 5, c(1), Time = TT2,LOP_order = 3)
result6_N = qsODE_all(dat, 6, c(1,5), Time = TT2,LOP_order = 3)
result7_N = qsODE_all(dat, 7, c(1,5), Time = TT2,LOP_order = 3)
result8_N = qsODE_all(dat, 8, c(1,5), Time = TT2,LOP_order = 3)
result9_N = qsODE_all(dat, 9, c(1,5), Time = TT2,LOP_order = 3)
...
pdf("M13_fig2_N.pdf",height = 8,width = 8)
plot.igraph(net,
            rescale = T,
